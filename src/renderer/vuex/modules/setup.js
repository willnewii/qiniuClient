...
const mutationsKeys = [
  ...
  types.setup.tray,
  types.setup.privatebucket,
  types.setup.isOverwrite,
  types.setup.downloaddir,
  types.setup.paging,
  types.setup.showMenuBar,
  types.setup.https,
  types.setup.deleteNoAsk,
  types.setup.uploadNoAsk,
  types.setup.copyType,
  types.setup.showType,
  types.setup.imagestyle,
  types.setup.theme,
  types.setup.recent,
]
