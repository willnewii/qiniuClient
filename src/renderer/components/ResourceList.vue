<template>
  <div ref="content" class="layout-content">
    <v-contextmenu ref="folderMenu" @contextmenu="handleFolderMenu">
      ...
      <v-contextmenu-item divider></v-contextmenu-item>
      <v-contextmenu-item v-if="!setup_hiddenDelBtn" @click="handleFolderMenuClick(0)"><span style="color: red; width: 300px">删除</span></v-contextmenu-item>
    </v-contextmenu>
    <v-contextmenu ref="fileMenu" @contextmenu="handleFileMenu">
      ...
      <v-contextmenu-item divider></v-contextmenu-item>
      <v-contextmenu-item v-if="!setup_hiddenDelBtn" @click="handleFileMenuClick(0)"><span style="color: red; width: 300px">删除</span></v-contextmenu-item>
    </v-contextmenu>
          ...
          <div class="item" @click="clickItem(file, files.indexOf(file))" v-contextmenu="file._directory ? 'folderMenu' : 'fileMenu'" :index="file">
            ...
            <template v-else>
              ...
              <div class="btn">
                ...
                <Button v-if="!setup_hiddenDelBtn" type="error" shape="circle" size="small" icon="md-trash" @click.stop="resourceRemove(file)"></Button>
              </div>
            </template>
          </div>
        </Card>
