                ...
                <div class="view" @click="show(index)">
                    ...
                    <div class="btn">
                        <Button type="ghost" shape="circle" size="small" icon="ios-download"
                                @click.stop="handleDownload(index)" style="background: #FFFFFF"></Button>
                        <Button type="ghost" shape="circle" size="small" icon="clipboard"
                                @click.stop="copy(index)" style="background: #FFFFFF"></Button>
                        <Button type="error" shape="circle" size="small" icon="trash-b"
                                @click.stop="resourceRemove(index)"></Button>
                    </div>
    ...
    export default {
        ...
        mounted() {
            ...
            this.bucket.files.forEach((file) => {
                let dirs = file.key.split(qiniu.DELIMITER);
                console.log(dirs);
            });
        },
        methods: {
